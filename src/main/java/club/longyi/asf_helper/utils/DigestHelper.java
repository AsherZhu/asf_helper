package club.longyi.asf_helper.utils;
...
public class DigestHelper {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        System.out.println( digest("123456", "MD5") );
        System.out.println( digest("123456", "SHA") );
        System.out.println( digest("123456", "SHA1") );
        System.out.println( digest("123456", "SHA-256") );
        System.out.println( digest("123456", "SHA-384") );
        System.out.println( digest("123456", "SHA-512") );
    }
}